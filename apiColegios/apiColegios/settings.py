"""
Django settings for apiColegios project.
...
SECRET_KEY = 'django-insecure-dgb9l2i_$t@&5mg(uc9)mv(eln#f(p6=q@8!4el#8pt5qnf2b3'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',
    'apiColegios.middleware.DisableCSRFMiddleware',
...
WSGI_APPLICATION = 'apiColegios.wsgi.application'
